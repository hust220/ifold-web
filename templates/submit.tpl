...
<table id="submitTable" border="0" cellpadding="0" cellspacing="0" class="ifoldTable" style="width:400px">
	...
	<tr>
		<td>Name of Task:</td>
		<td><input id="name" type="text" name="name" value="{$user->get('username')}.{php}echo date("m\.d\.y\-G\:i"){/php}"/></td>
	</tr>
	<tr>
		<td>Description of Task:</td>
		<td><input id="description" type="text" name="description" value="{$user->get('username')}.{php}echo date("m\.d\.y\-G\:i"){/php}" /></td>
	</tr>
</table><br/>
