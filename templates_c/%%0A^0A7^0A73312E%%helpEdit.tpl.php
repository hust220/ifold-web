<?php /* Smarty version 2.6.11, created on 2011-08-08 16:04:23
         compiled from helpEdit.tpl */ ?>
...
<input type="hidden" id="id" name="id" value="<?php echo $this->_tpl_vars['helpdata']->get('id'); ?>
" />
Name: <input id="name" type="text" name="name" value="<?php echo $this->_tpl_vars['helpdata']->get('name'); ?>
" style="width:200px" maxlength="40" /><br/>
Description: <input id="description" type="text" name="description" value="<?php echo $this->_tpl_vars['helpdata']->get('description'); ?>
" style="width:200px" maxlength="40" /><br/>
Security level required to view page: <input id="level" type="text" name="level" value="<?php echo $this->_tpl_vars['helpdata']->get('level'); ?>
" style="width:20px" maxlength="2" /><br/>
<?php echo '
